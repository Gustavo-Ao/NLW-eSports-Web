  ...
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="bg-nlw-gradient self-stretch rounded-lg mt-8 pt-1 overflow-hidden">
        <div className="bg-[#2A2634] h-28 py-6 px-8 flex justify-between items-center">
          <div>
            <strong className="text-white text-2xl block">Não encontrou seu duo?</strong>
            <span className="text-zinc-400 block">Publique um anúncio para encontrar novos players!</span>
          </div>

          <button className="py-2 px-4 bg-violet-500 hover:bg-violet-600 text-white rounded flex items-center gap-3">
